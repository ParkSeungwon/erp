...
public:
	...
	template<class... T> bool insert(AutoIncrement ai, T... b)
	{
		auto_increment_pos_ = pos_++;
		return insert(b...);
	}
	bool insert();
...
protected:
	...
	int column_count_;
	int auto_increment_pos_ = -1, pos_ = 0;//for autoincrement template use like insert(AI, "sh");
